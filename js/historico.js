...
function buscarIdsPartidaDoHistorico(puuid){
    if(!puuid){
        return false;
    }
...
function buscarDadosDaPartida(partidasId, puuid){
    $("#historicoTodasPartidas").html("");
    ...
    idPartidas.forEach(idpartida => {
        const dadosPartida = fazGet(requestApi.baseApiAmerica+"/lol/match/v5/matches/"+idpartida+"?api_key="+requestApi.apiKey);
        ...
        // console.log(vitoria);
        const classeDerrota = vitoria ? '' : 'derrota';
        var rowHtml = `
            <div class="row rowPaiPartida ">
                            ...
                            <div class="col-2 p-0 divPaiDadoPartida ${classeDerrota}">
                                <div class="row ${classeDerrota}">
                                    ...
                                    <div class="col-12 textStatusPartida">${vitoria ? 'Vitória' : 'Derrota'}</div>
                                    ...
                                    <div class="col-5 divPaiSpellRunaPartida ${classeDerrota}">
                                        <div class="row divSpellPartida ${classeDerrota}">
                                            <div class="meuTooltip p-0 col-4">
                                                <img class="imgSpellPartida" src="https://ddragon.leagueoflegends.com/cdn/${versaoAPI}/img/spell/${feitico_D.image.full}" alt="Descrição da Imagem" title="Texto da dica de ferramenta">
                                            ...
                                            <div class="meuTooltip p-0 col-4">
                                                <img class="imgSpellPartida" src="https://ddragon.leagueoflegends.com/cdn/${versaoAPI}/img/spell/${feitico_F.image.full}" alt="Descrição da Imagem" title="Texto da dica de ferramenta">
